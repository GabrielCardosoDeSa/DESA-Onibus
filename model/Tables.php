...
include_once($_SERVER['DOCUMENT_ROOT'].'/safira/model/Database.php');
include_once($_SERVER['DOCUMENT_ROOT'].'/safira/model/Bus.php');
...
//        print_r($this->columnsTable);
    ...
    public function find($where)
    {
        ...
        while($item = mysqli_fetch_assoc($result))
        {
            $model = "\\safira\\".ucfirst($this->nameTable);
            $object = new $model();
